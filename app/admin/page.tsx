    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Overview of store performance and management tools</p>
        </div>
                  ...
                  {lowStockProducts.slice(0, 5).map((product) => (
                    <div key={product.id} className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Tenant: {product.tenantId}</p>
                      </div>
                  ...
                  {recentPayments.slice(0, 5).map((payment) => (
                    <div key={payment.id} className="flex items-center justify-between p-3 border rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Tenant: {payment.tenantName}</p>
